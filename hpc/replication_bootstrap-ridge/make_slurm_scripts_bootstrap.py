...
def create_scripts_replication2(
    ...
    combinations = list(product(SUBJECTS, N_STORIES, FEATURES))

    for tup in combinations:
        subject, n_stories, feat = tup

        script_name = f"repli-bootstrap_{subject}-{n_stories}-{feat}.script"
        ...
        script_f.write("--ridge_implementation 'ridge_chunkbootstrap' \\\n")
